...
class LocalModelAnnotation {
  ...
  Map<String, Object?> toJson() => <String, Object?>{
    ...
    if (screenshotPngBase64 != null) 'screenshotPngBase64': screenshotPngBase64,
  };
  ...
  static String encodeList(List<LocalModelAnnotation> annotations) =>
      jsonEncode(
        annotations.map((item) => item.toJson()).toList(growable: false),
      );
...
class LocalAnnotationStore {
  ...
  Future<void> save(
    ...
    await _preferences.setString(
      key,
      LocalModelAnnotation.encodeList(annotations),
    );
  }
}
