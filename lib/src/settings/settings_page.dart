...
class SettingsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // SettingsPage is also used independently in widget tests and alternate
    // shells. Own a Material surface instead of relying on an ancestor shell;
    // ListTile/SwitchListTile ink and accessibility semantics then remain valid
    // in every embedding context.
    return Material(
